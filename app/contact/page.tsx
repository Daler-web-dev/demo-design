        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="bg-gray-200 rounded-[3rem] overflow-hidden h-[500px] relative shadow-inner">
            <div className="absolute inset-0 bg-brand-100 flex flex-col items-center justify-center p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-brand-900 mb-2">Interactive Map</h3>
              <p className="text-brand-700">Find us near the Samarkand State University campus, right at the corner of Universitet Boulevard.</p>
              <button className="mt-8 bg-white text-brand-900 px-8 py-3 rounded-full font-bold shadow-lg">Open in Google Maps</button>
            </div>
          </div>
        </div>
      </section>
