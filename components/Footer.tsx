      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 mb-20">
          ...
          <div className="grid grid-cols-2 gap-10">
            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 mb-8">Navigation</h4>
              <ul className="space-y-4 font-bold text-lg">
                <li><Link href="/courses" className="hover:text-gold">Catalog</Link></li>
                <li><Link href="/about" className="hover:text-gold">The Network</Link></li>
                <li><Link href="/contact" className="hover:text-gold">Contact</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 mb-8">Headquarters</h4>
              <p className="font-bold text-lg mb-4">Universitet Blvd 77, <br />Samarkand, UZ</p>
              <p className="text-indigo-400 font-black">+998 66 123 45 67</p>
            </div>
          </div>
        </div>
